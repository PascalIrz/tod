...
#' contours <- osm_communes_tod(url = url, repertoire = "raw_data", crs_sortie = 2154)
#' }
osm_communes_tod <- function(url, repertoire, crs_sortie = NA)

{
  # Téchargement du shapefile des contours des départements
  fichier_destination <- paste0(repertoire, "/communes-20190101.zip")
  ...
  geojson_communes <- paste0(repertoire, "/communes-20190101.json")
